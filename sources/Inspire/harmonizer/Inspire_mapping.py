...
def harmonize_buildings_static(data, **kwargs):
    ...
    df_point = pd.json_normalize(json_data['buildings']['punto'])
...
def harmonize_buildings_space_static(data, **kwargs):
    ...
    df_point = pd.json_normalize(json_data['buildingsSpaces']['punto'])
...
def harmonize_address_static(data, **kwargs):
    ...
    df_point = pd.json_normalize(json_data['address']['punto'])
